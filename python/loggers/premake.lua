...
package.name = "pyRheiaLoggers"

-- Set this if you want a different name for your target than the package's name.
local targetName = "_loggers"
local version = "1.1.1"
...
package.includepaths = { "../../include/rheia/loggers" , "../../include/rheia/python" ,"../../include/rheia/base" , "../../include/rheia/utils" , "$(WXPYTHON)/include" , "../../include/irrlicht" , "../../src/irrlicht", "/usr/include/python" .. python_ver }

-- Set the packages dependancies. NOT implimented in the official Premake build for Code::Blocks
package.depends = { "rheialoggers" }
