...
WX_DECLARE_STRING_HASH_MAP( swig_type_info*, RheiaPythonPackageTypeInfoHashMap );
...
// SWIG tables for it.
PyObject* RheiaPythonPackagePtrTypeMap = PyDict_New();
 
static
swig_type_info* RheiaPythonPackageFindSwigType(const wxString& className) {

    static RheiaPythonPackageTypeInfoHashMap* typeInfoCache = NULL;

    if (typeInfoCache == NULL)
        typeInfoCache = new RheiaPythonPackageTypeInfoHashMap;
    ...
    if (! swigType) {
        ...
        if (!swigType) {
            ...
            if ((item = PyDict_GetItemString(RheiaPythonPackagePtrTypeMap,
...
bool RheiaPythonPackageCheckSwigType(const wxString& className) {
    ...
    swig_type_info* swigType = RheiaPythonPackageFindSwigType(className);
...
// object for it.    
PyObject* RheiaPythonPackageConstructObject(void* ptr,
                              const wxString& className,
                              int setThisOwn) {

    swig_type_info* swigType = RheiaPythonPackageFindSwigType(className);
    wxCHECK_MSG(swigType != NULL, NULL, wxT("Unknown type in RheiaPythonPackageConstructObject"));
...
bool RheiaPythonPackageConvertSwigPtr(PyObject* obj, void **ptr,
                        const wxString& className) {

    swig_type_info* swigType = RheiaPythonPackageFindSwigType(className);
    wxCHECK_MSG(swigType != NULL, false, wxT("Unknown type in RheiaPythonPackageConvertSwigPtr"));
...
PyObject* RheiaPythonPackageMakeSwigPtr(void* ptr, const wxString& className) {
    
    PyObject* robj = NULL;

    swig_type_info* swigType = RheiaPythonPackageFindSwigType(className);
    wxCHECK_MSG(swigType != NULL, NULL, wxT("Unknown type in RheiaPythonPackageMakeSwigPtr"));
...
bool RheiaPythonPackageInstance_Check(PyObject* obj) {
...
bool RheiaPythonPackageSwigInstance_Check(PyObject* obj) {
...
static RheiaPythonCoreAPI API = {
    ...
    RheiaPythonPackageCheckSwigType,
    RheiaPythonPackageConstructObject,
    RheiaPythonPackageConvertSwigPtr,
    RheiaPythonPackageMakeSwigPtr
};
...
%init %{
    ...
    PyDict_SetItemString(d,"_RheiaPythonPackageAPI", cobj);
    Py_XDECREF(cobj);
%}
