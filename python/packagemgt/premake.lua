...
package.name = "pyRheiaPackagemgt"

-- Set this if you want a different name for your target than the package's name.
local targetName = "_packagemgt"
local version = "1.1.1"
...
package.includepaths = { "../../include/rheia/packagemgt" , "../../include/rheia/python" ,  "../../include/rheia/loggers" , "../../include/rheia/base" , "../../include/rheia/utils" , "$(WXPYTHON)/include" , "../../include/irrlicht" , "../../src/irrlicht", "/usr/include/python" .. python_ver }

-- Set the packages dependancies. NOT implimented in the official Premake build for Code::Blocks
package.depends = { "rheiapackagemgt" }
...
package.config["Release"].postbuildcommands = { CP .. "packagemgt.py ../rheia" }
package.config["Debug"].postbuildcommands = { CP .. "packagemgt.py ../rheia_d" }
