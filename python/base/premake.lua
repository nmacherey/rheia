...
package.name = "pyRheiaBase"

-- Set this if you want a different name for your target than the package's name.
local targetName = "_base"
local version = "1.1.1"
...
package.config["Release"].postbuildcommands = { CP .. "base.py ../rheia" }
package.config["Debug"].postbuildcommands = { CP .. "base.py ../rheia_d" }
