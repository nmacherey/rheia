...
package.name = "pyRheiaWorkspacemgt"

-- Set this if you want a different name for your target than the package's name.
local targetName = "_workspacemgt"
local version = "1.1.1"
...
package.depends = { "rheiaworkspacemgt" }
...
package.config["Release"].postbuildcommands = { CP .. "workspacemgt.py ../rheia" }
package.config["Debug"].postbuildcommands = { CP .. "workspacemgt.py ../rheia_d" }
