...
package.name = "rheiawebconnect"
-- set this if you want a different name for your target than the package's name.
local targetName = "rheiawebconnect"
-- common setup
package.language = "c++"
...
-- package files
package.files = { matchfiles( "../../webconnect/src/*.cpp" , "../../webconnect/include/*.h" ) }

-- set the include paths.
package.includepaths = { "../../webconnect/include" }
...
table.insert( package.config["Release"].defines , { "WEBCONNECT_MAKINGDLL" } )
table.insert( package.config["Debug"].defines , { "WEBCONNECT_MAKINGDLL" } )
