...
-- package files
package.files = { matchfiles( "../../src/rheia/python/*.cpp" , "../../src/rheia/python/*.h" ), matchfiles( "../../include/rheia/python/*.h" ) }

-- set the include paths.
package.includepaths = { "../../include/rheia/python" , "../../include/rheia/editor" , "../../include/rheia/loggers" , "../../include/rheia/base" , "../../include/rheia/utils" , "../../include/rheia/packagemgt" , "../../include/rheia/workspacemgt" }
...
table.insert( package.config["Release"].defines , { "RHEIA_PYTHON_MAKINGDLL" } )
table.insert( package.config["Debug"].defines , { "RHEIA_PYTHON_MAKINGDLL" } )

-- add the related links for plplot
table.insert( package.links , { "rheiautils" , "rheiabase" , "rheialoggers" , "rheiaeditor" , "rheiapackagemgt" , "rheiaworkspacemgt" } );
