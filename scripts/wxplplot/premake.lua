...
package.name = "rheiawxplplot"
-- Set this if you want a different name for your target than the package's name.
local targetName = "rheiawxplplot"
-- Common setup
package.language = "c++"
...
-- package files
package.files = { matchfiles( "../../src/wxplplot/*.cpp", "../../src/wxplplot/*.hpp", "../../src/wxplplot/*.cxx", "../../src/wxplplot/*.h", "../../src/wxplplot/*.cc", "../../src/wxplplot/*.hh" , "../../src/wxplplot/*.c" ), matchfiles( "../../include/wxplplot/*.h" ) }
...
table.insert( package.config["Release"].defines , { "plplotwxwidgetsd_EXPORTS" , "plplotcxxd_EXPORTS" } )
table.insert( package.config["Debug"].defines , { "plplotwxwidgetsd_EXPORTS" , "plplotcxxd_EXPORTS" } )

-- Add the related links for plplot
table.insert( package.links , { "rheiacsirocsa" , "rheiaqsastime" , "rheiaplplot" } );
