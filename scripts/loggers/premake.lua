...
-- package files
package.files = { matchfiles( "../../src/rheia/loggers/*.cpp" , "../../src/rheia/loggers/*.h" ), matchfiles( "../../include/rheia/loggers/*.h" ) }

-- set the include paths.
package.includepaths = { "../../include/rheia/loggers" , "../../include/rheia/base" , "../../include/rheia/utils" , "../../webconnect/include" }
...
table.insert( package.config["Release"].defines , { "RHEIA_LOGGERS_MAKINGDLL" } )
table.insert( package.config["Debug"].defines , { "RHEIA_LOGGERS_MAKINGDLL" } )

-- add the related links for plplot
table.insert( package.links , { "rheiautils" , "rheiawebconnect" , "rheiabase" } );
