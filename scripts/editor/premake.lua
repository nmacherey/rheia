...
-- package files
package.files = { matchfiles( "../../src/rheia/editor/*.cpp" , "../../src/rheia/editor/*.h" ), matchfiles( "../../include/rheia/editor/*.h" ) }

-- set the include paths.
package.includepaths = { "../../include/rheia/editor" , "../../include/rheia/loggers" , "../../include/rheia/base" , "../../include/rheia/utils" }
...
table.insert( package.config["Release"].defines , { "RHEIA_EDITOR_MAKINGDLL" } )
table.insert( package.config["Debug"].defines , { "RHEIA_EDITOR_MAKINGDLL" } )

-- add the related links for plplot
table.insert( package.links , { "rheiautils" , "rheiabase" , "rheialoggers" } );
