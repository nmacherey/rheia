...
-- package files
package.files = { matchfiles( "../../src/rheia/workspacemgt/*.cpp" , "../../src/rheia/workspacemgt/*.h" ), matchfiles( "../../include/rheia/workspacemgt/*.h" ) }

-- set the include paths.
package.includepaths = { "../../include/rheia/workspacemgt" , "../../include/rheia/packagemgt" , "../../include/rheia/loggers" , "../../include/rheia/base" , "../../include/rheia/utils" , "../../webconnect/include" }
...
table.insert( package.config["Release"].defines , { "RHEIA_WMGT_MAKINGDLL" } )
table.insert( package.config["Debug"].defines , { "RHEIA_WMGT_MAKINGDLL" } )

-- add the related links for plplot
table.insert( package.links , { "rheiautils" , "rheiawebconnect" , "rheiabase" , "rheialoggers" , "rheiapackagemgt" } );
