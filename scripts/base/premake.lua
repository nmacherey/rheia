...
-- package files
package.files = { matchfiles( "../../src/rheia/base/*.cpp" , "../../src/rheia/base/*.h" ), matchfiles( "../../include/rheia/base/*.h" ) }

-- Set the include paths.
package.includepaths = { "../../include/rheia/base" , "../../include/rheia/utils" , "../../webconnect/include" }
...
table.insert( package.config["Release"].defines , { "RHEIA_BASE_MAKINGDLL" } )
table.insert( package.config["Debug"].defines , { "RHEIA_BASE_MAKINGDLL" } )

-- Add the related links for plplot
table.insert( package.links , { "rheiautils" , "rheiawebconnect" } );
