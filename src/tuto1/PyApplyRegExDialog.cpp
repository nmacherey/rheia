...
PyApplyRegExDialog::PyApplyRegExDialog( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) :
...
PyApplyRegExDialog::~PyApplyRegExDialog()
{
}

void PyApplyRegExDialog::EndModal(int retCode)
{
    if( retCode == wxID_OK )
    {
