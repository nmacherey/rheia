...
if ( not windows ) then
	package.files = { matchfiles( "*.cpp", "*.hpp", "*.cxx", "*.h", "*.cc", "*.hh" , "*.c" ), matchfiles( "../../include/wxwidgets/*.h" ) }
else
	package.files = { matchrecursive( "*.cpp", "*.hpp", "*.cxx", "*.h", "*.cc", "*.hh" , "*.c" ) , matchrecursive( "../../include/wxwidgets/*.h" ) }
end
...
-- Set the defines.
package.defines = { "HAVE_CONFIG_H" , "wxwidgets_EXPORTS" }
