...
if( macosx ) then
    CP="cp -r "
    package.config["Debug"].links = { "rheiautils-dbg" }
	package.config["Release"].links = { "rheiautils" }
else
    CP="cp -ru "
end
...
--*********************************
	...
	if ( (not options["cb-msvc8"]) and (string.find( target or "", ".*-gcc" ) or target == "gnu") ) then
		...
		package.config["Release"].postbuildcommands = { "gmkdir -p ../../../devel/Release/include/rheia" , "cp -ru .../../../include/rheia/base ../../../devel/Release/include/rheia" }
		package.config["Debug"].postbuildcommands = { "gmkdir -p ../../../devel/Debug/include/rheia" , "cp -ru ../../../include/rheia/base ../../../devel/Debug/include/rheia" }
	else
		...
		table.insert( package.buildoptions, "/DRHEIA_BASE_MAKINGDLL" )
