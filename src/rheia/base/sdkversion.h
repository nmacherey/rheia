...
namespace AutoVersion{
	...
	static const long REVISION = 6981;
	
	//Miscellaneous Version Types
	static const long BUILDS_COUNT = 1446;
	#define RC_FILEVERSION 1,15,1112,6981
	#define RC_FILEVERSION_STRING "1, 15, 1112, 6981\0"
	static const char FULLVERSION_STRING[] = "1.15.1112.6981";
