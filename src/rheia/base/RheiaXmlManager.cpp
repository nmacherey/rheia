...
{
static wxString DynLibName 						= wxT("name");
...
//    if ( SubPaths.size() == 0 )
//        RheiaThrow( wxT("Error, cannot read your subpath, it seems to be empty") );
...
*/
void RheiaXmlManager::Write(const wxString& name,  const wxString& value, xmlNode* pathNode, bool ignoreEmpty)
{
...
void RheiaXmlManager::Write(const wxString& key, const char* str, xmlNode* pathNode)
{
    ...
    Write(key, RheiaC2U(str), pathNode, false);
};

wxString RheiaXmlManager::Read(const wxString& name, xmlNode* rootNode, const wxString& defaultVal)
{
    wxString ret;
...
bool RheiaXmlManager::Read(const wxString& name, wxString* str, xmlNode* rootNode )
{
    wxString key(name);
...
void RheiaXmlManager::Write(const wxString& name, xmlNode *rootNode , const wxColour& c)
{
    /*
    ...
    */
    ...
    /* Check if the name node exists in the root node otherwise create it */
...
wxColour RheiaXmlManager::ReadColour(const wxString& name, xmlNode *rootNode , const wxColour& defaultVal)
{
    wxColour ret;
...
bool RheiaXmlManager::Read(const wxString& name, xmlNode *rootNode , wxColour* ret)
{
    wxString key(name);
...
void RheiaXmlManager::Write(const wxString& name, xmlNode* rootNode,  int value)
{
    wxString key(name);
...
int  RheiaXmlManager::ReadInt(const wxString& name, xmlNode* rootNode,  int defaultVal)
{
    int ret;
...
bool RheiaXmlManager::Read(const wxString& name, xmlNode* rootNode ,  int* value)
{
    wxString key(name);
...
void RheiaXmlManager::Write(const wxString& name, xmlNode* rootNode,  bool value)
{
    wxString key(name);
...
bool  RheiaXmlManager::ReadBool(const wxString& name, xmlNode* rootNode,  bool defaultVal)
{
    bool ret;
...
bool RheiaXmlManager::Read(const wxString& name, xmlNode* rootNode, bool* value)
{
    wxString key(name);
...
void RheiaXmlManager::Write(const wxString& name,   xmlNode* rootNode, double value)
{
    wxString key(name);
...
double  RheiaXmlManager::ReadDouble(const wxString& name,  xmlNode* rootNode,  double defaultVal)
{
    double ret;
...
bool RheiaXmlManager::Read(const wxString& name,  xmlNode* rootNode, double* value)
{
    wxString key(name);
...
void RheiaXmlManager::Set(const wxString& name, xmlNode* rootNode)
{
    wxString key(name);
    xmlNode* e = AssertPath(key, rootNode);
...
void RheiaXmlManager::UnSet(const wxString& name, xmlNode* rootNode)
{
    wxString key(name);
...
void RheiaXmlManager::Write(const wxString& name, xmlNode* rootNode,  const wxArrayString& arrayString)
{
    wxString key(name);
...
void RheiaXmlManager::Read(const wxString& name, xmlNode* rootNode, wxArrayString *arrayString)
{
    wxString key(name);
...
wxArrayString RheiaXmlManager::ReadArrayString(const wxString& name, xmlNode* rootNode)
{
    wxArrayString as;
...
void RheiaXmlManager::Write(const wxString& name, xmlNode* rootNode,  const wxArrayInt& arrayInt)
{
    wxString key(name);
...
void RheiaXmlManager::Read(const wxString& name, xmlNode* rootNode, wxArrayInt *arrayInt)
{
    wxString key(name);
...
wxArrayInt RheiaXmlManager::ReadArrayInt(const wxString& name, xmlNode* rootNode)
{
    wxArrayInt ai;
    Read(name, rootNode, &ai);
    return ai;
}

void RheiaXmlManager::Write(const wxString& name, xmlNode* rootNode,  const wxArrayDouble& arrayDouble)
{
    wxString key(name);
...
void RheiaXmlManager::Read(const wxString& name, xmlNode* rootNode, wxArrayDouble *arrayDouble)
{
    wxString key(name);
...
wxArrayDouble RheiaXmlManager::ReadArrayDouble(const wxString& name, xmlNode* rootNode)
{
    wxArrayDouble ad;
    Read(name, rootNode, &ad);
    return ad;
}

void RheiaXmlManager::Write(const wxString& name, xmlNode* rootNode,  const wxArrayBool& arrayBool)
{
    wxString key(name);
...
void RheiaXmlManager::Read(const wxString& name, xmlNode* rootNode, wxArrayBool *arrayBool)
{
    wxString key(name);
...
wxArrayBool RheiaXmlManager::ReadArrayBool(const wxString& name, xmlNode* rootNode)
{
    wxArrayBool ab;
    Read(name, rootNode, &ab);
    return ab;
}

void RheiaXmlManager::Write(const wxString& name, xmlNode* rootNode,  const std::vector<bool>& arrayBool)
{
    wxString key(name);
...
void RheiaXmlManager::Read(const wxString& name, xmlNode* rootNode, std::vector<bool> *arrayBool)
{
    wxString key(name);
...
std::vector<bool> RheiaXmlManager::ReadStdArrayBool(const wxString& name, xmlNode* rootNode)
{
    std::vector<bool> ab;
    Read(name, rootNode, &ab);
    return ab;
...
void RheiaXmlManager::Write(const wxString& name, xmlNode* rootNode,  const std::vector<double>& arrayDouble)
{
    wxString key(name);
...
void RheiaXmlManager::Read(const wxString& name, xmlNode* rootNode, std::vector<double> *arrayDouble)
{
    wxString key(name);
...
std::vector<double> RheiaXmlManager::ReadStdArrayDouble(const wxString& name, xmlNode* rootNode)
{
...
void RheiaXmlManager::Write(const wxString& name, xmlNode* rootNode,  const std::vector<int>& arrayInt)
{
    wxString key(name);
...
void RheiaXmlManager::Read(const wxString& name, xmlNode* rootNode, std::vector<int> *arrayInt)
{
    wxString key(name);
...
std::vector<int> RheiaXmlManager::ReadStdArrayInt(const wxString& name, xmlNode* rootNode)
{
    std::vector<int> ai;
    Read(name, rootNode, &ai);
    return ai;
...
void RheiaXmlManager::Write(const wxString& name, xmlNode* rootNode,  const std::vector<std::string>& arrayString)
{
    wxString key(name);
...
void RheiaXmlManager::Read(const wxString& name, xmlNode* rootNode, std::vector<std::string> *arrayString)
{
    wxString key(name);
...
std::vector<std::string> RheiaXmlManager::ReadStdArrayString(const wxString& name, xmlNode* rootNode)
{
...
{
    wxString key(path + _T("/dummy")); // the trailing slash hack is required because AssertPath expects a key name
    xmlNode* e = AssertPath(key,rootNode);
    wxArrayString ret;
...
//void RheiaXmlManager::Write( const wxString name, xmlNode* rootNode , const RheiaDynamicLibrary& dynamicLibrary, bool overwrite_existing )
//{
//
//    /** @note this function is simply writing a dynamic_library node to the node given by name
//    */
//    wxString key(name);
//
//    xmlNode* node = AssertPath(key,rootNode);
//    xmlNode* e = GetUniqElement(node,key);
//
//    /* Now we have to check in childrens if the library already exists */
//    xmlNode *child = e->children;
//
//    while( child != NULL )
//    {
//        wxString temp_node = RheiaC2U( (const char*) child->name );
//
//        if( temp_node.IsSameAs( XmlManagerPaths::DynLibNode ) )
//        {
//            wxString child_name = RheiaNodeGetProp( xmlGetProp( child , rxU2C( XmlManagerPaths::DynLibAttributes::DynLibName ) ) );
//            wxString child_subsyst = RheiaNodeGetProp( xmlGetProp( child , rxU2C( XmlManagerPaths::DynLibAttributes::DynLibSubSystem ) ));
//
//            if( child_name.IsSameAs( dynamicLibrary.Name ) && child_subsyst.IsSameAs( dynamicLibrary.Subsystem ) )
//            {
...
//    }
//
//    /* the dynamic library is written at the end of the node */
//    xmlNode* dynlib = xmlNewNode( NULL , rxU2C( XmlManagerPaths::DynLibNode ) );
//
//    xmlNewProp( dynlib , rxU2C( XmlManagerPaths::DynLibAttributes::DynLibName ),
//                rxU2C( dynamicLibrary.Name )) ;
//
//    xmlNewProp( dynlib , rxU2C( XmlManagerPaths::DynLibAttributes::DynLibSubSystem ),
//                rxU2C( dynamicLibrary.Subsystem )) ;
//
//    if( child != NULL )
//        xmlReplaceNode( child , dynlib );
//    else
//        xmlAddChild( e , dynlib );
//
//}
//
//void RheiaXmlManager::Write(  const wxString name, xmlNode* rootNode , const RheiaDynamicLibraryTable& dynamicLibraries, bool overwrite_existing )
//{
//    for( unsigned int i = 0; i < dynamicLibraries.size() ; i++ )
//    {
//        Write( name, rootNode, dynamicLibraries[i] , overwrite_existing );
//    }
//}
//
//void RheiaXmlManager::Read(  const wxString name, xmlNode* rootNode , const wxString& LibName, RheiaDynamicLibrary* dynamicLibrary )
//{
//    /**
//    	@note this function is simply read a dynamic_library node to the node given by name
//    */
//    wxString key(name);
//
//    xmlNode* node = AssertPath(key,rootNode);
...
//            wxString child_subsyst = RheiaNodeGetProp( xmlGetProp( child , rxU2C( XmlManagerPaths::DynLibAttributes::DynLibSubSystem ) ));
//
//            if( child_name.IsSameAs( LibName ) )
//            {
//                dynamicLibrary->Name = child_name;
//                dynamicLibrary->Subsystem = child_subsyst;
//                return;
//            }
//        }
//        child = child->next;
...
//}
//
//void RheiaXmlManager::Read( const wxString name, xmlNode* rootNode , RheiaDynamicLibraryTable* dynamicLibraries )
//{
//    /**
//    	@note this function is simply read a dynamic_library node to the node given by name
//    */
...
//            wxString child_subsyst = RheiaNodeGetProp( xmlGetProp( child , rxU2C( XmlManagerPaths::DynLibAttributes::DynLibSubSystem ) ));
//
//            RheiaDynamicLibrary dynamicLibrary;
//
//            dynamicLibrary.Name = child_name;
//            dynamicLibrary.Subsystem = child_subsyst;
//
...
//}
//
//RheiaDynamicLibrary RheiaXmlManager::ReadDynamicLibrary( const wxString& name, xmlNode* rootNode, const wxString LibName )
//{
//    RheiaDynamicLibrary retLib ;
//    Read( name , rootNode , LibName, &retLib );
//    return retLib;
//}
//
//RheiaDynamicLibraryTable RheiaXmlManager::ReadDynamicLibraryTable( const wxString& name, xmlNode* rootNode )
//{
//    RheiaDynamicLibraryTable retLib ;
//    Read( name , rootNode , &retLib );
//    return retLib;
//}

void RheiaXmlManager::Write(const wxString& name, xmlNode* rootNode, const wxSize& size)
{
    wxString key(name);
...
void RheiaXmlManager::Write(const wxString& name, xmlNode* rootNode, const wxFont& font)
{
    wxString key(name);
...
bool RheiaXmlManager::Read(const wxString& name, xmlNode* rootNode, wxFont *font)
{
    wxString key(name);
...
wxFont RheiaXmlManager::ReadFont(const wxString& name, xmlNode* rootNode )
{
    wxFont ret;
...
void RheiaXmlManager::Write(const wxString& name, xmlNode* rootNode, const wxTextAttr& attr)
{
    wxString key(name);
...
wxTextAttr RheiaXmlManager::ReadTextAttr(const wxString& name, xmlNode* rootNode )
{
    wxTextAttr ret;
...
bool RheiaXmlManager::Read(const wxString& name, xmlNode* rootNode, wxTextAttr *attr)
{
    wxString key(name);
...
bool RheiaXmlManager::Read(const wxString& name, xmlNode* rootNode, wxSize *size)
{
    wxString key(name);
...
wxSize RheiaXmlManager::ReadSize(const wxString& name, xmlNode* rootNode,const wxSize& defaultSize)
{
    wxSize ret;
...
void RheiaXmlManager::Write(const wxString& name, xmlNode* rootNode, const wxPoint& pos)
{
    wxString key(name);
...
bool RheiaXmlManager::Read(const wxString& name, xmlNode* rootNode, wxPoint* pos)
{
    wxString key(name);
...
wxPoint RheiaXmlManager::ReadPosition(const wxString& name, xmlNode* rootNode,const wxPoint& defaultPos)
{
    wxPoint ret;
