...
if( macosx ) then
    CP="cp -r "
    package.config["Debug"].links = { "rheiautils-dbg" , "rheiabase-dbg" , "rheialoggers-dbg" , "rheiapackagemgt-dbg" }
	package.config["Release"].links = { "rheiautils" , "rheiabase" , "rheialoggers" , "rheiapackagemgt" }
else
    CP="cp -ru "
end
