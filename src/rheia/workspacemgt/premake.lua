...
package.name = "rheiaworkspacemgt"

-- Set this if you want a different name for your target than the package's name.
local targetName = "rheiaworkspacemgt"
local version = "1.1.1"
...
if ( not windows ) then
	package.files = { matchfiles( "*.cpp", "*.hpp", "*.cxx", "*.h", "*.cc", "*.hh" , "*.c" ), matchfiles( "../../../include/rheia/workspacemgt/*.h" ) }
else
	package.files = { matchrecursive( "*.cpp", "*.hpp", "*.cxx", "*.h", "*.cc", "*.hh" , "*.c" ) , matchrecursive( "../../../include/rheia/workspacemgt/*.h" ) }
end

-- Set the include paths.
package.includepaths = { "../../../include/rheia/workspacemgt" , "../../../include/rheia/packagemgt" , "../../../include/rheia/loggers" , "../../../include/rheia/base" , "../../../include/rheia/utils" , "../../../include/irrlicht" , "../../../src/irrlicht" }
...
-- Set the defines.
package.defines = { "HAVE_CONFIG_H", "RHEIA_WMGT_MAKINGDLL" , "RHEIA_USE_IRRLICHT" }
