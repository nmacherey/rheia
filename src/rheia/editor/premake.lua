...
package.name = "rheiaeditor"

-- Set this if you want a different name for your target than the package's name.
local targetName = "rheiaeditor"
local version = "1.1.1"
...
if ( not windows ) then
	package.files = { matchfiles( "*.cpp", "*.hpp", "*.cxx", "*.h", "*.cc", "*.hh" , "*.c" ), matchfiles( "../../../include/rheia/editor/*.h" ) }
else
	package.files = { matchrecursive( "*.cpp", "*.hpp", "*.cxx", "*.h", "*.cc", "*.hh" , "*.c" ) , matchrecursive( "../../../include/rheia/editor/*.h" ) }
end

-- Set the include paths.
package.includepaths = { "../../../include/rheia/editor" , "../../../include/rheia/packagemgt" , "../../../include/rheia/loggers" , "../../../include/rheia/base" , "../../../include/rheia/utils" , "../../../include/irrlicht" , "../../../src/irrlicht" }

-- Set the packages dependancies. NOT implimented in the official Premake build for Code::Blocks
package.depends = { "rheiautils" , "rheiabase" , "rheiapackagemgt" }

-- Set the defines.
package.defines = { "HAVE_CONFIG_H", "RHEIA_EDITOR_MAKINGDLL" }
...
--*********************************
	...
	if ( (not options["cb-msvc8"]) and (string.find( target or "", ".*-gcc" ) or target == "gnu") ) then
		...
		package.config["Release"].postbuildcommands = { "gmkdir -p ../../../devel/Release/include/rheia" , "cp -ru .../../../include/rheia/editor ../../../devel/Release/include/rheia" }
		package.config["Debug"].postbuildcommands = { "gmkdir -p ../../../devel/Debug/include/rheia" , "cp -ru ../../../include/rheia/editor ../../../devel/Debug/include/rheia" }
	else
		...
		table.insert( package.buildoptions, "/DRHEIA_EDITOR_MAKINGDLL" )
