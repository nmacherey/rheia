...
if ( windows ) then
	package.files = { matchrecursive( "*.cpp", "*.hpp", "*.cxx", "*.h", "*.cc", "*.hh" , "*.c" ), matchrecursive( "../../include/irrlicht/*.cpp", "../../include/irrlicht/*.hpp", "../../include/irrlicht/*.cxx", "../../include/irrlicht/*.h", "../../include/irrlicht/*.cc", "../../include/irrlicht/*.hh" ) }
elseif ( macosx ) then
...
--*********************************
	if ( (not options["cb-msvc8"]) and (string.find( target or "", ".*-gcc" ) or target == "gnu") ) then
		...
		package.config["Release"].postbuildcommands = { "gmkdir -p ../../devel/Release/include/rheia" , "cp -ru ../../include/irrlicht ../../devel/Release/include/rheia" }
		package.config["Debug"].postbuildcommands = { "gmkdir -p ../../devel/Debug/include/rheia" , "cp -ru ../../include/irrlicht ../../devel/Debug/include/rheia" }
	else
		...
		table.insert( package.buildoptions, "/DIRRLICHT_EXPORTS" )
