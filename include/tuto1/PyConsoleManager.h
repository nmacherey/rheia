...
#ifndef PYCONSOLE_MANAGER_H
#define PYCONSOLE_MANAGER_H
...
#include <wx/menu.h>
 ...
 /**
*   @class PyConsoleManager
*   @brief this is the basic class for handling styled text control informations
*/
class PyConsoleManager : public wxEvtHandler, public RheiaPageContainer , public RheiaMgr<RheiaManagedFrame,PyConsoleManager>
{
    friend class RheiaMgr<RheiaManagedFrame,PyConsoleManager>;
...
private :
	...
	*   PyConsoleManager::Get(Frame) to get the global instance of this class.
	*/
    PyConsoleManager(RheiaManagedFrame* parent);

    /**
	*   Default destructor
	*   You cannot directly destroy this manager, you have to call
	*   PyConsoleManager::Free(Frame) to do this. However you may NEVER
	*   call PyConsoleManager::Free(Frame) this might result in big troubles
	*   in rheia. For information, RheiaManager will free this manager at application
	*   ShutDown.
	*/
    virtual ~PyConsoleManager();
