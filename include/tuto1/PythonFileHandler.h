...
#ifndef PYTHON_FILE_HANDLER_H
#define PYTHON_FILE_HANDLER_H
...
*   @version 0.1.0
*/
class PythonFileHandler : public PyFileHandler
{
public :
    ...
    /** destructor */
    virtual ~PythonFileHandler();

    /** copy ctor */
    PythonFileHandler(const PythonFileHandler& rhs);
