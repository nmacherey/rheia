/**
*   @file RheiaEditorBase.h
*
*   @author Nicolas Macherey (nm@graymat.fr)
*   @date 12-March-2010
*   @version 0.0.1
*/
#ifndef RheiaEditor_h_
#define RheiaEditor_h_
...
public :
    ...
    */
    RheiaEditorBase( RheiaManagedFrame* toplevel , wxWindow* parent , RheiaEditorFile* container , RheiaEditorLayout* context );

    /** Default dtor (do not forgot to make it virtual...) */
    virtual ~RheiaEditorBase();
    ...
    **************************************************************************************/
    ...
    RheiaEditorFile* GetContainer( ) {return m_container;};

    /** Set the editor associated container
    *   @param container new container for this editor
    */
    void SetContainer( RheiaEditorFile* container );
...
protected :
    ...
    * it will call RheiaEditorBase::AddContextMenuStuff() in order to allow any
