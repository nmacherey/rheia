...
*/
/**
*   @file RheiaEditorLayout.h
*
*   @author Nicolas Macherey (nm@graymat.fr)
*   @date 12-March-2010
*   @version 0.0.1
*/
#ifndef RheiaEditorLayout_H
#define RheiaEditorLayout_H
...
*/
class EDITOR_DLLEXPORT RheiaEditorLayout : public wxObject
{
    DECLARE_ABSTRACT_CLASS(RheiaEditorLayout)
...
public :
    ...
    **************************************************************************************/
    ...
    virtual wxStcPropertyMap GetPropertyMap()
    {
		...
		m_props[ wxT("fold.comment.cpp")] = wxT("1");
        m_props[ wxT("fold.quotes.cpp")] = wxT("1");
