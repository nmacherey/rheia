...
/**
*   @file RheiaCenterMgrSettingsPanel.h
*
*   @author Nicolas Macherey (nm@graymat.fr)
*   @version 0.0.1
*   @date 17-November-2009
*/
#ifndef RheiaCenterMgrSettingsPanel_h_
#define RheiaCenterMgrSettingsPanel_h_
...
/**
*   @class RheiaCenterMgrSettingsPanel
*
...
*   @date 17-November-2009
*/
class BASE_DLLEXPORT RheiaCenterMgrSettingsPanel : public RheiaConfigurationPanel
{
public:
    /*******************************************************************************
    ...
    */
	RheiaCenterMgrSettingsPanel( wxWindow* parent );
	
	/** default destrcutor */
	virtual ~RheiaCenterMgrSettingsPanel() {};
	...
	*/
	virtual wxString GetTitle() const { return wxT("Center Window Settings"); };
