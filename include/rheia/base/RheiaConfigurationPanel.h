/**
*   @file RheiaConfigurationPanel.h
*
*   @author Nicolas Macherey (nm@graymat.fr)
*   @version 0.0.1
*   @date 17-November-2009
*/
#ifndef RheiaConfigurationPanel_h_
#define RheiaConfigurationPanel_h_
...
*   @date 17-November-2009
*/
class BASE_DLLEXPORT RheiaConfigurationPanel : public wxPanel
{
public:
    /*******************************************************************************
