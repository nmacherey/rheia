...
/**
*   @file RheiaLeftMgrSettingsPanel.h
*
*   @author Nicolas Macherey (nm@graymat.fr)
*   @version 0.0.1
*   @date 17-November-2009
*/
#ifndef RheiaLeftMgrSettingsPanel_h_
#define RheiaLeftMgrSettingsPanel_h_
...
/**
*   @class RheiaLeftMgrSettingsPanel
*
...
*   @date 17-November-2009
*/
class BASE_DLLEXPORT RheiaLeftMgrSettingsPanel : public RheiaConfigurationPanel
{
public:
    /*******************************************************************************
    ...
    */
	RheiaLeftMgrSettingsPanel( wxWindow* parent );
	
	/** destructor */
	virtual ~RheiaLeftMgrSettingsPanel() {};
